...
documents turns into a "Run App" button. Clicking on this button starts the app
and opens it in the viewer pane or a new window. To make sure the complete
functionality of the app is working, it is better to run it in a new window
(click on the right-side down arrow and select "Run in Window", then click on
"Run App").
